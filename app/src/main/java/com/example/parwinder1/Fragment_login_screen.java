...
class LoginScreen extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragment_login_screen, container, false);
    }
    ...
    public void onClick(View view) {
        ...
        {
            NavController navController = Navigation.findNavController(getActivity(),R.id.fragment_login_screen);
    ...
    public void updateUI(FirebaseUser user)
    {
        ...
        navController.navigate(R.id.action_fragment_login_screen_to_fragment_dashboard,b);
