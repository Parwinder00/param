...
class Register extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragment_registed, container, false);
    }
...
*/
        ...
        NavController navController = Navigation.findNavController(getActivity(),R.id.fragment_registed);

        navController.navigate(R.id.btn_login);
