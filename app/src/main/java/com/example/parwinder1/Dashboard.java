...
public class Dashboard extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Signout = view.findViewById(R.id.btn_logut);
        Delete_User = view.findViewById(R.id.btn_del);
        ...
        Signout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavController navController = Navigation.findNavController(getActivity(),R.id.fragment_dashboard);
                navController.navigate(R.id.fragment_login_screen);
            }
        });
    ...
    public void delUser(View v)
    {
        ...
        View popupview  = getActivity().getLayoutInflater().inflate(R.layout.fragment_fragment_login_screen, null);
        ...
        final EditText edt_email = popupview.findViewById(R.id.edt_username);
        final EditText edt_pass = popupview.findViewById(R.id.edt_lpass);
        final Button btn_sub = popupview.findViewById(R.id.btn_register);
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful())
                                                    {
                                                        NavOptions navOptions = new NavOptions.Builder()
                                                                ...
                                                                .build();
                                                        NavController navController = Navigation.findNavController(getActivity(),R.id.fragment_dashboard);
                                                        navController.navigate(R.id.fragment_login_screen,null,navOptions);
                                                        popupWindow.dismiss();
